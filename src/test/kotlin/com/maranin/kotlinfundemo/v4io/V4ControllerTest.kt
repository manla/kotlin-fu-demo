...
@SpringBootTest
internal class V4ControllerTest {

    @Autowired
    lateinit var baseController: BaseController

    @Autowired
    lateinit var controller: V4Controller
    ...
    inner class GetInvoice {
        ...
        fun getInvoiceFornegativeHours() {
            ...
            val error = invoiceObject as InvoiceError
            expectThat(error.exception).isEqualTo("InvalidEntryException")
        }
        ...
        fun getInvoiceForUnknownDay() {
            ...
            expectThat(invoiceObject).isA<InvoiceError>()
            val error = invoiceObject as InvoiceError
            expectThat(error.exception).isEqualTo("NoEntryAvailableException")
        }
